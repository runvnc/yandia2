# codec_hf.py - HuggingFace MimiModel wrapper (BACKUP)
# This is the original HuggingFace-based codec implementation.
# To revert to this version, simply copy this file to codec.py:
#   cp dia2/audio/codec_hf.py dia2/audio/codec.py
#
# The current codec.py uses the native Kyutai Mimi from the moshi package
# which has built-in streaming support.
